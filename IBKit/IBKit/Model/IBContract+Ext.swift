...
public extension IBContract {
    ...
    static func future(localSymbol: String, currency: String, size: Double? = nil, exchange: IBExchange = .CME)
        -> IBContract
    {
    ...
    static func option(localSymbol: String, currency: String, size: Double? = nil, exchange: IBExchange = .CME)
        -> IBContract
    {
